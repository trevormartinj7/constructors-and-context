...
function Car(make, model, year){
  ...
  */
  ...
  User.prototype.addSavedPost = function(idA, titleA, ratingA){
    let postObj = {
      id: idA,
      title: titleA,
      rating: ratingA,
  ...
  User.prototype.removeSavedPost = function(idA){
    for(let i = 0; i < this.savedPosts.length; i++){
      if(idA == this.savedPosts[i].id){
  ...
  User.prototype.changePostRating = function(idA, ratingA){
    for(let i = 0; i < this.savedPosts.length; i++){
      if(idA == this.savedPosts[i].id){
        console.log(ratingA);
        this.savedPosts[i].rating = ratingA;
      }
    }
  }
